# Checkout Payment Method Customizations

![payment-methods-customization](img/payment-methods-customization.png)


This extension allows you to customize the payment methods displayed on the checkout page:

- Freely change the display order of each payment methods.
- Freely change each payment method's name, description, logo and the supported credit card's logo.
- Limit payment methods by the order total amount. It's possible to limit by minimum or maximum amount.
- Limit payment methods by product conditions (New, Used or Refurbished).
...
<script src="https://d3r059eq9mm6jz.cloudfront.net/croxcheckout.public.js" async defer></script>
```
...
- Configure how to display your payment methods.
- Default:
...
```js
{
    ...
    paypalcommerce: {
        titleImg: 'https://cdn11.bigcommerce.com/r-fc1004fc93d5d0867d67e043f9ec4d0a0bf67d29/img/payment-providers/paypal_commerce_logo.svg',
        titleImgAlt: 'Paypal',
    ...
    'afterpay-PAY_BY_INSTALLMENT': {
        title: 'Pay over time',
        titleImg: 'https://cdn11.bigcommerce.com/r-fc1004fc93d5d0867d67e043f9ec4d0a0bf67d29/img/payment-providers/afterpay-badge-blackonmint.png',
...
**Payment methods are specfied in the list:**
...
Please contact us if any of your payment method is not listed above.

**Settings for each payment method:**

- `title`: Payment method name.
- `titleImg`: Payment method image (Optional).
- `titleImgAlt`: Alt text for the payment method image (Optional).
- `icons`: Array of card icons displayed (Optional). Example: `['visa', 'mastercard', 'amex', 'jcb']`.
- `order`: Sort order number (Optional).
- `minAmount`: Limit the payment method by minimum order amount (Optional). Example: `100`.
- `maxAmount`: Limit the payment method by minimum order amount (Optional). Example: `1000`.
- `productConditionsDisable`: Limit the payment method by product conditions (Optional). Example: `['Used', 'Refurbished']`.


### paymentMethodLabelTemplate

- Template for displaying the payment method.
- Default:
